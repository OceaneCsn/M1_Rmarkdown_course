...
author: "Océane Cassan - oceane.cassan@lirmm.fr"
date: "08/31/2021"
output:
  html_document:
    theme: united
...
L'idée est de générer un rapport identique à [celui- ci](Solution.html) pour illustrer les fonctionnalités de `Rmarkdown`.
...
A la fin de ces guidelines, vous devriez avoir un document très proche de la [solution](Solution.html)!
