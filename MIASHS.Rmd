...
+ Navigateur de fichiers, setting du repertoire de travail
...
La syntaxe de Rmarkdown dont vous allez avoir besoin par la suite est dans cette [cheat sheet](<https://raw.githubusercontent.com/rstudio/cheatsheets/master/rmarkdown-2.0.pdf>), gardez ce document ouvert.
...
Tout d'abord, nous aurons besoin de certains packages. Assurez-vous de leur installation avant de commencer : Dans la console R, exécutez `install.packages(c("ggplot2", "dplyr", "stringr", "igraph", "plotly", "visNetwork"))` pour tous les installer depuis CRAN.)), 
...
<div class="spoiler">
  ...
  **dplyr** : manipulation de dataframes
  
  **stringr** : manipulation de chaînes de caractères
  
  **igraph** : manipulation de graphes
  
  **plotly** : graphiques interactfs 
  
  **visNetwork** : affichage de réseaux interactifs
