...
L'idée est de générer un rapport identique à [celui- ci](https://oceanecsn.github.io/M1_Rmarkdown_course/)
...
Choisissez un emplacement et créez votre projet. A la racine du projet, créez un folder "data", dans lequel [télécharger les données](https://raw.githubusercontent.com/OceaneCsn/M1_Rmarkdown_course/master/data/burghardt_et_al_2015_expt1.csv) que nous allons utiliser aujourd'hui pour illustrer les fonctionnalités de Rmarkdown.
...
Vous remarqurez ici que la fonction `ggplotly` permet de rendre interactif le graphe ggplot.
